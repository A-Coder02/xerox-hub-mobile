...
import colors from "../../utils/colors"; // Importing colors

const ImageSvgicon = ({
  width = 49,
  height = 49,
  color = colors.imageIcon, // Using the imageIcon color from the colors folder
  ...props
}) => (
  <Svg
    width={width}
  ...
  >
    <Path
      ...
      stroke={color} // Updated to use the color prop
      strokeWidth={3}
      strokeLinecap="round"
