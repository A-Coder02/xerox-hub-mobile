...
const items = [
  ...
  { id: '4', title: 'My Favourites', icon: FavouriteSvg, route: 'FavouritesScreen' },
  { id: '5', title: 'Contact Us', icon: ContactSvg, route: 'FavouritesScreen' },
  { id: '6', title: 'Features', icon: SparkleSvg, route: 'FavouritesScreen' },
  { id: '7', title: 'My Favourites', icon: SettingSvg, route: 'FavouritesScreen' },
];
      ...
      <ScrollView>
        ...
        >
          <View style={modalBackground}>
            <View style={modalBox}>
              <Typography variant="h3" fontWeight={600} style={{ marginBottom: 16 }}>
                Confirm Logout
              </Typography>
              <Typography variant="body2" color="gray" style={{ marginBottom: 24 }}>
